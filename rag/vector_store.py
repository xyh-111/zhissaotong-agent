...
class VectorStoreService:
    ...
    def ger_retriever(self):
        return self.vctor_store.as_retriever(search_kwargs={"k": chroma_conf["k"]})
    ...
    def load_document(self):
        ...
        for path in allowed_file_path:
            ...
            try:
                ...
                #将内容存入向量库
                self.vctor_store.add_documents(splite_document)
